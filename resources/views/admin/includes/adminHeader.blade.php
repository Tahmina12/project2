            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-users fa-fw" style="color:red;">{{$i}}</i> <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-messages">
                       <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('admin/request')}}">You have {{$i}} Pending Request</a>
                                </li>
               ...
               <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                       <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('admin/request')}}">No Request</a>
                                </li>
